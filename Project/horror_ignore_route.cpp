#include<iostream>
#include "horror_AwareAvoid_route.cpp"
...
void scenario1_choice1(){
  ...
  switch (choice){
    ...
    case '2':
      ...
      cout << "Slightly freaked out, you ask him if it could be a wild animal nearby. He shrugs and says you're probably right." << endl;
      cout << "He then asks if you'd want to move the campsite or if you don't mind staying." << endl;
      move_route1();
      break;
    default:
     cout << "Please choose again." << endl;
