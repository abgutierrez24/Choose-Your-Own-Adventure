...
void choiceOG3(){
  ...
  switch (choice){
    case '1':
    cout << "After a few more minutes, you're halfway done setting up your tent" << endl;
    cout << "when your friend approaches you with a weird look on his face." << endl;
...
void choiceOG2(){
  ...
  switch (choice){
    case '1':
      ...
      break;
    case '2':
      cout << "you live" << endl; // GO BACK TO JAIR'S STORY
      break;
    default:
      cout << "Please choose again." << endl;
      choiceOG2();
